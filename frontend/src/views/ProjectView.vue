                ...
                <div v-if="quotaHasOauth && quotaComputed" class="sidebar-footer-usage">
                    ...
                    <AppTooltip v-if="quotaFiveHour" for="quota-five-hour" hoist force>
                        <div class="quota-tooltip">
                            ...
                            <div class="quota-tooltip-row" v-if="quotaFiveHour.recentLong.rate != null"><span class="quota-tooltip-label">Recent rate ({{ formatRecentDelta(quotaFiveHour.recentLong.deltaMs, false, quotaFiveHour.recentLong.lookbackMs) }})</span><span>{{ (quotaFiveHour.recentLong.rate * 100).toFixed(0) }}%</span></div>
                            <div class="quota-tooltip-row" v-if="quotaFiveHour.recentShort.rate != null"><span class="quota-tooltip-label">Recent rate ({{ formatRecentDelta(quotaFiveHour.recentShort.deltaMs, false, quotaFiveHour.recentShort.lookbackMs) }})</span><span>{{ (quotaFiveHour.recentShort.rate * 100).toFixed(0) }}%</span></div>
                    ...
                    <AppTooltip v-if="quotaSevenDay" for="quota-seven-day" hoist force>
                        <div class="quota-tooltip">
                            ...
                            <div class="quota-tooltip-row" v-if="quotaSevenDay.recentLong.rate != null"><span class="quota-tooltip-label">Recent rate ({{ formatRecentDelta(quotaSevenDay.recentLong.deltaMs, true, quotaSevenDay.recentLong.lookbackMs) }})</span><span>{{ (quotaSevenDay.recentLong.rate * 100).toFixed(0) }}%</span></div>
                            <div class="quota-tooltip-row" v-if="quotaSevenDay.recentShort.rate != null"><span class="quota-tooltip-label">Recent rate ({{ formatRecentDelta(quotaSevenDay.recentShort.deltaMs, true, quotaSevenDay.recentShort.lookbackMs) }})</span><span>{{ (quotaSevenDay.recentShort.rate * 100).toFixed(0) }}%</span></div>
