...
- Refactor git resolution: cache-free filesystem reads in the live watcher (detects branch switches and new repos immediately), CWD fallback for Bash-only sessions, session git propagation moved from item-level to session-level
